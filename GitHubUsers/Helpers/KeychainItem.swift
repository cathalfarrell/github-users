...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.cathalfarrell.GitHubUsers", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.cathalfarrell.GitHubUsers", account: "userIdentifier").deleteItem()
        } catch {
